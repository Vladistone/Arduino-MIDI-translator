...
and keep looking for the limit of headroom of synth output... But would you wish to increase it a bit more...upto *127%*? __Another One Bites the Dust__
image:IMAGES/COM_IMG/Anothe one.jpeg[,80,80,role="related thumb right"]_Mmmm..._ it's Easy! By external Sysex, if you don't pay attention to the manual at all.
Bit I'm ask myself: Why the produser didn't it itself? Or is have a reasons?:
|===
