...
|===
|element/param|Nucleus|DSS-1| note for DSS-1 parameters:

|fader and rotary V-coder|32|45+| incl. mode, request, and CC#:
|switch, button|32|16(+15)| CC#1, 2, 7, 122, 123, 124-125
|Total|64|77+| but most DSS-1 params don't require permanent Cntrl.
|===
