...
while training the limit of powerful headroom of synth output... But it would you wish to increase up to duble 127% by external Sysex commands? if you don't pay attention to the manual at all.
