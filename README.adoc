...
while training the limit of powerful synth headroom of output. But it would be increase up to 127% with external Sysex commands if you don't pay attention to the manual at all.
Why produser didn't it itself? Or is have a reasons?:
|===
