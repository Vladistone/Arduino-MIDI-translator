...
====
|====
|*_Please note that these synthesizers partially implement control of CC# parameters that I defined as "reserved" by default! such as:_* 2+.8+
|| CC01 | OSC Modulation
|| CC02 | VCF Modulation
