...
- he prefers an independent control option for the `OSC 1 & 2` parameters separetly with the ability to raise the level of both oscillators up to 100% "fat", while training the powerful OUTPUT from the synthesizer may be increas upto 127% with external Sysex comands:
