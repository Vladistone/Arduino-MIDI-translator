...
and keep looking for the limit of powerful headroom of synth output... But would you wish to increase it a bit more... upto duble 127%? "Another One Bites the Dust"
image:IMAGES/COM_IMG/Anothe one.jpeg[,100,100]
So it's Easy! By external Sysex...
if you don't pay attention to the manual at all.
