...
while going to lookinh for the limit of powerful headroom of synth output... But would you wish to increase it a bit more... upto duble 127%? So it's Easy! By external Sysex... if you don't pay attention to the manual at all.
