...
|Sysex_6 byte leight| <<Unit_0>> | unuse | use
|Sysex_8 byte leight| <<Unit_1>> | in progress | use
|Sysex_9 byte leight| <<Unit_2>> | unuse | use
|Sysex_10 byte leight| <<Unit_3>> |inprogress| use
|Ctlr_2_Synth map layout| <<Unit_4>> |use | use
|setup & loop| *[Unit_5]* | |
|===
