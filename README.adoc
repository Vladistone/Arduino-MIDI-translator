...
|`Osc MG Mod Selelect`| Sw Off (Osc1, Osc2) Both|within parentheses are unattainability Synth state of 4-step parameter if applicate by 2-state switch controller (meaning on/off operation)
|===
