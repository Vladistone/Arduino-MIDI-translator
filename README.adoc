...
| Korg <<DW8000>> with Arduino chipping; .3+|image:IMAGES/Korg DW8000/Korg DW-8000 6.jpeg[,400,300]
| cleared, Adjusted, silent and soft touched keys board;
| a built-in arduino nano for MIDI translator CC2SysEx;
| a modern 3-pin AC-Plug with line-filter; w/local AC-transformator 
| Korg <<EX8000>> with the same upgrade; .2+|image:IMAGES/Korg EX8000/korg EX-8000.jpg[,400,300]
| a built-in arduino nano for MIDI translator CC2SysEx;
|===
