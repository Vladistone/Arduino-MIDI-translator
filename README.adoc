...
switch, button - 32
and you can use 2 DAW-mode buttons for double the number of options upto 64+64
vs
DSS-1 has the ability to program 77 or more parameters (including Mode request and 4 CC)
Of these, changes are constant in smoothness - more than 45 parameters (you can count more if you include in this list all parameters except switches)
switch parameters - 16 plus 15+ Mode switches
only 31+
