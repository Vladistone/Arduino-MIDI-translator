...
while training the limit of powerful headroom of synth output... But would you wish to increase it up to duble 127% by external Sysex commands? Easy!.. if you don't pay attention to the manual at all.
