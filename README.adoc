...
====
|===
|if you don't pay attention to the manual at all - it's will made Easy... by external SysEx messages __another one bites the dust__ |image:IMAGES/COM_IMG/Anothe one.jpeg[,80,80,right]
|===
====
