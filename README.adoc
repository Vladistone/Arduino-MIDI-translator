...
|===
|element/param|Nucleus|DW-8p|EX/DW8000|DSS-1| note for DSS-1 parameters:

|fader and rotary V-coder|32|48|48|45+| incl. mode, request, and CC#:
|switch, button|32|16(+15)|2|2(+3)| CC#1, 2, 7, 122, 123, 124-125
|Total|64|77+|50|50| but most DSS-1 params don't require permanent Ctrl.
|===

image:IMAGES/Retroactive DW-8P controller.jpeg[,1000,300]
