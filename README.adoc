...
|`Osc MG Mod Selelect`| Sw Off (Osc1, Osc2) Both|within parentheses wouldn't work if use off/on Switchs. where in brackets are the values that are unattainable when using the button 0-127
|===
