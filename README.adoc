...
.code for DSS-1 with the operation of scaling the СС# value 127 upto 500 by arithmetic multiplication and division CC value (*252/64). followed by a left shift of bytes between MSB and LSB
[%collapsible]
====
[,cpp,%linenums]
----
