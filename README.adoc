...
But would you wish to increase it a bit more...upto *127%*? it's Easy... by external Sysex, if you don't pay attention to the manual at all image:IMAGES/COM_IMG/Anothe one.jpeg[,80,80,right]
