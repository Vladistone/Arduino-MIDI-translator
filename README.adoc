...
which is available on the https://glenstegner.com/dss1/home.html[Glen Stegner] [image:IMAGES/COM_IMG/GlenSiegner.png[Glen Stegner,,]] and this site author very deeply described all the possibilities in the work of DSS-1.
