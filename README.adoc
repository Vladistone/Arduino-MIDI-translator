...
you can, together with other performance equipment give a new life to old synthesizers from the 80s such as the Korg DW/EX-8000 or DSS-1 using Arduino and with programming skills!
____

This Simple Arduino project to remap MIDI `CC#` messages into `SysEx` messages that Synth expects.
...
|===
| parts | main variable | DW/EX8000| DSS-1

| <<Unit_0>> | Sysex_6 byte leight | unuse | use
| <<Unit_1>> | Sysex_8 byte leight| in progress | use
| <<Unit_2>> | Sysex_9 byte leight | unuse | use
| <<Unit_3>> | Sysex_10 byte leight| inprogress| use
| <<Unit_4>> | Ctlr_2_Synth map layout| use | use
| *[Unit_5]* | setup & loop | |
|===
...
.https://github.com/Vladistone/Arduino-MIDI-translator/blob/master/REPO/SSL_DSS_fix1.ino[*DSS-1*] code [Unit_1]
[%collapsible]
====
[,cpp,%linenums]
----
...
.https://github.com/Vladistone/Arduino-MIDI-translator/blob/master/REPO/MIDI_DW8000_2024.ino[*DW/EX8000*] code [Unit_1]
[%collapsible]
====
[,cpp,%linenums]
----
...
I called this encoding:   "2in1 parameter control"
[#Unit_3]
.[UNIT_3]
[%collapsible]
====
