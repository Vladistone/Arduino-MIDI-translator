...
[*All done*]...
image:IMAGES/under controller.jpg[,100,50] Relax and take it easy! or wait a minute...
[WARNING]
because after downloading the sketch to the Arduino: since if you have read up to this point...
then you are probably a noob like I was at the beginning of this journey of getting to know arduino.
And if you have experience with Arduino codes, then you have probably already
begun to analyze the code markup template for convenience and compatibility with your equipment...

. That time has come to adapt the Arduino to staff of MIDI devices and decide:
  * is this map layout convenient for your *Cntrl_2_Synth* combination or whether need to remap the code?
