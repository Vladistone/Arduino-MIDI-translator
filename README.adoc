...
|`[F11] Osc 1 Octave`|16 (8) 4 .7+|within parentheses are unattainability Synth state of 4-step parameter if applicate by 2-state switch controller (meaning on/off operation)
