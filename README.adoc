...
. Make sure your `MIDI_library.h` is enabled in kbd:[*Sketch*] → kbd:[*Include Library*] → kbd:[*Manage Librarys ⇧⌘i*] →  kbd:[*download*] or kbd:[*upgrade:] the `MIDI_library.h` if you need...
  * For the Arduino board device, tick for your name kbd:[*device*]
  * and tick your kbd:[*Port*] for connection.
