...
while training the limit of powerful headroom of synth output... But would you wish to increase it up to duble 127%? it's Easy! By external Sysex... if you don't pay attention to the manual at all.
