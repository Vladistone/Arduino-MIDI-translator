...
[Warring]
----
pay attantion: not use the param.Offset parameter. it wrong this misconception is passed down from generation to generation!
----
and the author of the first draft also did not understand the difference, https://gearspace.com/board/showpost.php?p=16795924&postcount=16[at gearspace.com have quote his comments]
