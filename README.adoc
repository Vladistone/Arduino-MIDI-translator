...
====
image:GlenSiegner.png[Glen Stegner]
...
image:IMAGES/Korg DSS-1/MODE_data.jpeg
====
...
TIP when working with correspondence tables, use Excel tables and convert hex or DEC data into a single, readable format.
...
image::IMAGES/Korg DSS-1/Sysex_Mix_ratio.png[,500,600]
====
...
image:IMAGES/Korg DSS-1/Sysex_Mix_ratio.png
