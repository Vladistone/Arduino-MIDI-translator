...
|`Osc MG Mod Selelect`| Sw Off (Osc1, Osc2) Both|within parentheses are unattainable Synth state if applicate the 2-state switch controller with on/off operation.
|===
