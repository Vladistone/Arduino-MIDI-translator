...
the DW8000 doesn't operate this SysEx below:
image:IMAGES/Korg DW8000/2in1 parameter control.png[,900,500]

==== [​​1by2 control with two buttons]
[TIPS]
...
of which the extreme two values ​​(off; Both) - can be easily implemented using a regular Switch off/on CC#1 value 0x00/0x7F.
