...
[#img-GlenStegner,link=https://glenstegner.com/dss1/home.html]
image:IMAGES/COM_IMG/GlenStegner.png[GlenStegner,800,30] and this site author very deeply described all the possibilities in the work of DSS-1.
