...
and keep looking for the limit of headroom of synth output... But would you wish to increase it a bit more... __Another One Bites the Dust__ upto duble 127%?
image:IMAGES/COM_IMG/Anothe one.jpeg[,80,80] Mmmm... it's Easy! By external Sysex, if you don't pay attention to the manual at all.
