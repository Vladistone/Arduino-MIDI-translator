...
the argument against to *separate control* is that it will get to achieve overload at the DAC output when playing particularly loud waves with distortion.
