...
which is available on the [#img-sunset,link=https://glenstegner.com/dss1/home.html]image:IMAGES/COM_IMG/GlenSiegner.png[Glen Stegner,50,20] and this site author very deeply described all the possibilities in the work of DSS-1.
