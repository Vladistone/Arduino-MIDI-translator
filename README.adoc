...
But would you wish to increase it a bit more...upto *127%*? if you don't pay attention to the manual at all.
by external Sysex it's Easy... image:IMAGES/COM_IMG/Anothe one.jpeg[,80,80,right]
