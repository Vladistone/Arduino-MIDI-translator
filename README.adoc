...
begun to analyze the mapping template for convenience and compatibility for your *Cntrl_2_Synth* equipment...  and decide: is whether need to remap the code?

because after downloading the sketch to the Arduino: That time has come to adapt the Arduino to staff of MIDI devices

. You can also check the functionality of this sketch in working conditions or by simulating MIDI monitoring. To do this, you need:
  * to have a separate MIDI interface and a shield to connect to the Arduino MIDI interface, or...
