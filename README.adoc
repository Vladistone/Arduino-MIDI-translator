...
|===
.2+|And this may be a controversial decision, since according to the reasoning on the https://glenstegner.com/dss1/home.html[Glen website]: He prefers an independent control option for the `OSC 1 & 2` parameters separetly with the ability to raise the level of both oscillators up to duble 100% of "fat", and keep looking for the limit of headroom of synth output... But would you wish to increase it a bit more...upto *127%*? it's Easy... by external Sysex, if you don't pay attention to the manual at all|.2+|image:IMAGES/COM_IMG/Anothe one.jpeg[,80,80]
|===
|===
