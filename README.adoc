...
. Make sure your `MIDI_library.h` is enabled in IDE menu: kbd:[*Sketch*] → kbd:[*Include Library*] → kbd:[*Manage Librarys*] `⇧⌘i`. if you need kbd:[*download*] or kbd:[*upgrade*] the `MIDI_library.h` - do it!
