...
and keep looking for the limit of powerful headroom of synth output... But would you wish to increase it a bit more... _Another One Bites the Dust_ upto duble 127%?
image:IMAGES/COM_IMG/Anothe one.jpeg[,80,80] So it's Easy! By external Sysex... if you don't pay attention to the manual at all.
