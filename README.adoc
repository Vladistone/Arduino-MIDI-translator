...
change to:
----
 371   case 0: sendParam_8(channel, 0, value); break; // [F14] 00 OSC1 Level
 372   case 1: sendParam_8(channel, 1, value); break; // [F14] 01 OSC2 Level
----
...
395    case 23: sendParam_8(channel, 69, value); break; // [F17] OSC MG intens
----
====
