...
.some notes present in the code as an addition:
|===
|Program parameter name|Function and state| notes
|`Osc MG Mod Selelect`| Sw Off (Osc1, Osc2) Both|State within parentheses are unattainable when using the button on/off
|===
