...
====
|===
|if you **don't pay attention** to the manual at all - due to SysEx messages it's will be made Easy...__another one bites the dust__ |image:IMAGES/COM_IMG/Anothe one.jpeg[,80,80,right]
|===
====
