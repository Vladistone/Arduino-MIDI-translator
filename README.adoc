...
|===
|And this may be a controversial decision, since according to the reasoning on the https://glenstegner.com/dss1/home.html[Glen website]:.2+|image:IMAGES/COM_IMG/Anothe one.jpeg[,75,75,right]
...
|and keep looking for the limit of headroom of synth output... But would you wish to increase it a bit more...upto *127%*? it's Easy... by external Sysex, if you don't pay attention to the manual at all.
