...
. Make sure `MIDI_library.h` is enabled in IDE Manage Librarys menu: kbd:[*Sketch*] → kbd:[*Include Library*] → kbd:[*Manage Librarys*] `⇧⌘i`. if you need kbd:[*download*] or kbd:[*upgrade*] the `MIDI_library.h` - do it!
