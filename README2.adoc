...
It turned out to be non-working and require debugging. The pull request were added after fixing, but I did not find any activity from the project's master.
So therefore, I independently continued the path of adapting the project for Korg DSS-1 and thanks to mentoring from experienced Arduino C++ coders. I achieved the first results literally a week after the analysis differ between DW8000 vs DSS-1.
