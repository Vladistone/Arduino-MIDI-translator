...
This parameter is also described in the Program Parameter table [3] and has a image:IMAGES/LSB_MSB data format.jpeg[note 2]: _Must be set for both oscilator so that OSC1 + OSC2 = 100_
