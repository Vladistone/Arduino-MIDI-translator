...
The project start from 5th July 2016 and based on a hack https://hackaday.io/project/12541-korg-dw-8000-midi-enhancer[Korg DW8000 midi enhancer] publication by Steve Baines https://github.com/sjbaines/Korg_DW-8000_Midi_Enhancer[and his code repo]. As His discribed His code was tested on the Korg DW8000 and may have been stable, but by the time November 2023, when I discovered this project on the network - I could not immediately run it on the EX8000.
It turned out to be non-working and require debugging for DW/EX synth. The pull request were added after fixing, but I did not find any activity from the project's mastermind.
Therefore, I independently continued the path of adapting the project for Korg DSS-1 and thanks to mentoring from experienced Arduino C++ coders. I achieved the first results literally a week after the analysis differ between DW8000 vs DSS-1.
